...
@app.get("get_historical_funding_rate/{symbol}/{limit}", description="### Get Historical Funding Rates\n\ a given symbol returns a list with the historical funding rate and if were a controversial period, provides a analysis about what happened with the price", tags=["Base Funding Rate"])
