...
async def main_testing():
    start_time = int(datetime(2023, 9, 1, 1).timestamp() * 1000)  # Earlier time
    end_time = int(datetime(2023, 9, 8).timestamp() * 1000)  # Later time

    bitget_layer = BitgetService()

    granularity = '15m'  # 1 minute granularity
