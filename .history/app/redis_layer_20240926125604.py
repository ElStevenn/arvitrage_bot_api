...
if __name__ == "__main__":
    ...
    whole_analysis_until_now = [
        ...
        },
        {
            "id": str(uuid.uuid4()),
            "period": datetime.utcnow().isoformat(),
            "funding_rate_value": 0.45,  # Funding rate < 0.5, no analysis
            "analysis": {}
        },
        {
            "id": str(uuid.uuid4()),
            "period": datetime.utcnow().isoformat(),
            "funding_rate_value": 0.6,  # Funding rate > 0.5, includes analysis
            "analysis": {
                "description": [
        ...
        },
        {
            "id": str(uuid.uuid4()),
            "period": datetime.utcnow().isoformat(),
            "funding_rate_value": 0.3,  # Funding rate < 0.5, no analysis
            "analysis": {}
        },
        {
            "id": str(uuid.uuid4()),
            "period": datetime.utcnow().isoformat(),
            "funding_rate_value": 0.75,  # Funding rate > 0.5, includes analysis
            "analysis": {
                "description": [
