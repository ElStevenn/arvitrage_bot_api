...
class FundingRateChart:
    ...
    daily_trend = self.daily_trend  # Assign in set_analysis()
        weekly_trend = self.weekly_trend  # Assign in set_analysis()
        volatility_index = self.volatility_index  # Assign in set_analysis()
        average_volume = self.average_trading_volume  # Assign in set_analysis()
