...
class RedisService:
    ...
    # FUNDING RATE
    def set_analysis_last_funding(self, symbol: str, funding_rate_analysis: dict):
        """
...
if __name__ == "__main__":
    ...
    whole_analysis_until_now = [
        ...
        },
        {
            "id": str(uuid.uuid4()),
            "period": datetime.utcnow().isoformat(),
            "funding_raste_value": 0.03,
            "analysis": {
                "description": [
                    "crypto remained stable for 6 hours, with minor fluctuations",
                    "1-minute spike of 0.2% during high-volume trading session"
                ],
                "8h_variation": 0.2,
                "10m_variation": 0.1,
                "1m_variation": 0.2,
        ...
        },
        {
            "id": str(uuid.uuid4()),
            "period": datetime.utcnow().isoformat(),
            "funding_raste_value": -0.02,
            "analysis": {
                "description": [
                    "sharp decline of 3% in 2 hours, followed by recovery",
                    "recovery of 1% in the last 4 hours",
                    "significant trading volume fluctuations during recovery phase"
                ],
                "8h_variation": -2.0,
                "10m_variation": -1.5,
                "1m_variation": -0.3,
                "daily_trend": "bearish",
                "weekly_trend": "slightly bearish",
                "volatility_index": 2.0,
                "average_trading_volume": 1200000,
        ...
        },
        {
            "id": str(uuid.uuid4()),
            "period": datetime.utcnow().isoformat(),
            "funding_raste_value": -0.01,
            "analysis": {
                "description": [
                    "gradual decline of 1% over 8 hours with minimal recovery",
                ...
                "1m_variation": -0.02,
                "daily_trend": "bearish",
                "weekly_trend": "strongly bearish",
                "volatility_index": 0.5,
                "average_trading_volume": 500000,
                "market_sentiment": "negative"
            }
        },
        {
